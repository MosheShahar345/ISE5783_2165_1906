...
public class TeapotTest {
	...
	private final Camera camera = new Camera(new Point(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, 1, 0)) //
			...
			.setImageWriter(imageWriter).setAdaptive(false).setThreadsCount(4).setDensity(5);
	...
	public void teapot() {
		...
		scene.getLights().add(new PointLight(new Color(500, 500, 500), new Point(100, 0, -100)).setKq(0.000001));
